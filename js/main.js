...
$(".page-first").addClass("animated zoomIn");
$.ajax({
type: "post",
url: "http://wx.nfdaily.cn/ghwsx/count.php?m=fupin",
dataType: "jsonp",
jsonpCallback: "jsonp",
...
jsonpCallback: "jsonp",
success : function(data){
$(".plus").show().addClass("animated fadeInUp").on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
